...
public class Program {
	public static void main(String[] args) {
		...
		do {
			...
			JOptionPane.showInputDialog(null, "O que você deseja converter?", "Menu", JOptionPane.INFORMATION_MESSAGE,
					null, converterOptions, converterOptions[0]);
			...
			Object value = JOptionPane.showInputDialog(null, "Escolha a moeda para qual deseja converter:", "Moedas",
			...
			try {
				...
				JOptionPane.showMessageDialog(frame, "O valor da conversão é de: R$ " + result, "Resultado",
			...
			Object objEscolha = JOptionPane.showConfirmDialog(null, "Deseja continuar?", "Selecione uma opção",
